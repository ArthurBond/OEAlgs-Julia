...
"""
    ...
    while flag==0
        ...
        for ild in range(1,length(load_list))
            ...
            voltages = abs.(DSS.CktElement.Voltages())
            println(voltages[1], "      ", voltages[1]-voltages[2])
...
filename = "/Users/abond/OEAlgs-Julia/data/Master_nando_neutral/Master.dss"
...
result_path = "/Users/abond/OEAlgs-Julia/data/prop_n/results.csv"
active_exp_val_path = "/Users/abond/OEAlgs-Julia/data/prop_n/active_exp_values.csv"
all_exp_val_path = "/Users/abond/OEAlgs-Julia/data/prop_n/all_volt_values.csv"
